                ...
                <form onSubmit={this.handleSubmit.bind(this)} className="form-horizontal">
                  <div className="form-group">
                    ...
                    <div className="col-sm-8">
                      ...
                      Your Name<sup>*</sup><input type="text" name="name" id="name" className="form-control" value={this.state.name} onChange={this.handleChange.bind(this)} />
                    </div>
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    <div className="col-sm-8">
                      <textarea name="message" id="message" rows="6" className="form-control" value={this.state.message} onChange={this.handleChange.bind(this)}></textarea>
                    </div>
                  </div>
                  ...
                  <div className="form-group">
                   ...
                   <div>  <Messages messages={this.props.messages} /></div>
                </form>
              </div>
            </div>
          </div>
